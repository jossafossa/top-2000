export default class SpotifyAuth {
  constructor() {
    this.authorizeURL =
      "https://www.jossafossa.nl/projects/spotidash-api/authorize.php";
    this.getTokenURL =
      "https://www.jossafossa.nl/projects/spotidash-api/getToken.php";
    this.refreshURL =
      "https://www.jossafossa.nl/projects/spotidash-api/refresh.php";
    this.events = {};
  }
